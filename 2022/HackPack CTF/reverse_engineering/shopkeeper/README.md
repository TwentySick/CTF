...
```
### Flag 3
I recognized all part of base64 they gave is encode from file ELF Execute.\
I decode it and turn it to Hex to get this file (I think Hex is more accurate than ASCII is)\
It's actually happened like what I think, I get that file and I use ghidra to check.\
Looking at function Level2 and function main, I know if I have 19 coins after buying key, I can go to Level 2.\
To get odd coins, I sell apple or orange one time and earn money like what I do to find Flag 2\
And, I successfully access to Level 2.\
After a little time trying, I spam '99999' to bet and I get the flag when I correct 4 times.\
Flag:
```
